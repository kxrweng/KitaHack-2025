        ...
        <ul className='flex flex-col gap-[12px]'>
          <li className='flex flex-col gap-[16px] bg-white p-[24px] outline-1 outline-slate-300 rounded-md text-xl text-slate-700'>
            <div className='flex justify-between'>
              <p>
                <a className='font-bold'>Question 1: </a>Could you tell me about
                a time you faced a challenge at work and how you handled it?
              </p>
              <img
                className='cursor-pointer'
                src={
                  display ? '/KeyboardArrowUp.svg' : '/KeyboardArrowDown.svg'
                }
            ...
            {display ? (
              <>
                <p>
                  <a className='font-bold'>Your Answer: </a>One time, I had a
                  difficult project with a tight deadline. It was really
                  stressful, but I worked hard and managed to complete it. It
                  was tough, but I got it done.
                </p>
          ...
          <li className='flex items-center justify-between bg-white p-[24px] outline-1 outline-slate-300 rounded-md text-xl text-slate-700'>
            <p>
              <a className='font-bold'>Question 2: </a>Tell me about a time you
              worked with a difficult team member. How did you handle it?
            </p>
            <img src='/KeyboardArrowDown.svg' />
          </li>
          <li className='flex items-center justify-between bg-white p-[24px] outline-1 outline-slate-300 rounded-md text-xl text-slate-700'>
            <p>
              <a className='font-bold'>Question 3: </a>Describe a time you
              received constructive criticism. How did you respond?
            </p>
            <img src='/KeyboardArrowDown.svg' />
          </li>
          <li className='flex items-center justify-between bg-white p-[24px] outline-1 outline-slate-300 rounded-md text-xl text-slate-700'>
            <p>
              <a className='font-bold'>Question 4: </a>Have you ever had to
              motivate a team during a difficult project? What did you do?
            </p>
            <img src='/KeyboardArrowDown.svg' />
          </li>
          <li className='flex items-center justify-between bg-white p-[24px] outline-1 outline-slate-300 rounded-md text-xl text-slate-700'>
            <p>
              <a className='font-bold'>Question 5: </a>Have you ever missed a
              deadline? What happened, and what did you learn?
            </p>
            <img src='/KeyboardArrowDown.svg' />
          </li>
          <li className='flex items-center bg-slate-700 p-[24px] outline-1 outline-slate-300 rounded-md text-xl text-white'>
            <p>
              <a className='font-bold'>Overall Feedback: </a>A decent try with
              the practice questions but there is certainly room for
              improvement. Practise using the STAR method more when answering
              behavioural questions so the interviewer has a deeper insight into
