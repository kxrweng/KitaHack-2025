    ...
    <div className='flex gap-[18px] w-full'>
      <div className='h-full w-[25vw] bg-white outline-1 outline-slate-300 p-[36px]'>
        <div className='flex flex-col gap-[36px]'>
          <img
            className='w-[120px] outline-4 outline-blue-700 rounded-[50%]'
            src='/UserAvatar.png'
          />
          <div className='flex flex-col gap-[4px]'>
            <h2 className='text-[32px] text-blue-900 font-bold'>{user.name}</h2>
          ...
          <div className='flex flex-col gap-[4px]'>
            <h4 className='text-md text-blue-900 font-semibold'>
              Field of Interest
            </h4>
          ...
          <button className='w-max px-[24px] py-[12px] bg-blue-700 text-white rounded-md'>
            Edit Profile
          </button>
        </div>
      </div>
        ...
        <div className='flex flex-col h-full bg-white outline-1 outline-slate-300 p-[36px] rounded-lg gap-[36px]'>
              ...
              <div className='flex flex-col w-full gap-[16px]'>
                <div className='flex flex-col'>
                  ...
                  <div className='relative bg-white p-[1px] w-full rounded-4xl'>
                    <div className='flex items-center justify-end pr-[36px] text-white h-[32px] bg-blue-900 w-[10%] rounded-4xl'>
                      10%
                    </div>
                  </div>
                </div>
                <div className='flex flex-col'>
                  ...
                  <div className='relative bg-white p-[1px] w-full rounded-4xl'>
                    <div className='flex items-center justify-end pr-[36px] text-white h-[32px] bg-blue-900 w-[30%] rounded-4xl'>
                      30%
                    </div>
                  </div>
                </div>
                <div className='flex flex-col'>
                  ...
                  <div className='relative bg-white p-[1px] w-full rounded-4xl'>
                    <div className='flex items-center justify-end pr-[36px] text-white h-[32px] bg-blue-900 w-[20%] rounded-4xl'>
                      20%
                    </div>
                  </div>
                </div>
                <div className='flex flex-col'>
                  ...
                  <div className='relative bg-white p-[1px] w-full rounded-4xl'>
                    <div className='flex items-center justify-end pr-[36px] text-white h-[32px] bg-blue-900 w-[40%] rounded-4xl'>
                      40%
                    </div>
                  </div>
                </div>
          ...
          <div className='flex flex-col gap-[16px]'>
            ...
            <div className='flex justify-between'>
              {Array.from({ length: 52 }, (_, i) => {
                const renderedCol =
                  i % 2 == 0
                    ? renderOneCol([0, 1, 6, 11, 2, 7, 12])
                    : renderOneCol([0, 0, 11, 1, 6, 2, 0]);
                return renderedCol;
              })}
            </div>
          </div>
          <div className='flex flex-col gap-[16px]'>
            <div className='flex justify-between items-center'>
              ...
              <button className='text-blue-900 outline-1 outeline-blue-900 px-[24px] py-[12px] rounded-lg'>
                View All
              </button>
            </div>
